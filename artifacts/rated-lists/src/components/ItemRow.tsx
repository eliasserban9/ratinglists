    ...
    <div ref={rowRef} className="flex flex-col rounded-xl overflow-hidden" style={{ backgroundColor: s.bg, border: `1px solid ${s.borderColor}`, zoom: `${Math.round(scale * 100)}%` }}>
      ...
      <div className="flex items-stretch">
        ...
        <div className="flex items-center gap-3 flex-1 px-3 py-3 min-w-0">
          {rank !== undefined && (
            <span className="w-5 text-center font-mono shrink-0" style={{ color: s.rankColor, fontSize: `${0.9 * textScale}rem` }}>
              {rank}
            </span>
          )}
          ...
          {renaming ? (
            <input
              ...
              style={{ borderColor: s.ratingColor, color: s.nameColor, fontSize: `${1.05 * textScale}rem` }}
              maxLength={80}
            ...
            <span
              ...
              style={{ color: s.nameColor, fontSize: `${1.05 * textScale}rem` }}
          ...
          <div className="flex items-center gap-2 shrink-0">
            <button
              ...
              style={{ color: s.ratingColor, fontSize: `${1.05 * textScale}rem` }}
